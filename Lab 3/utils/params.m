...
%% Estimated Params From Lab 0
Beq_hat    = 1.217759983460570e-06;
Tau_sf_hat = 0.005709830270008;
Jeq_hat    = 5.604163427985364e-07;

%% DC Gear Motor Modeling Abstract Variables
...
% Mechanical Dynamics
MechDyn.num = 1;
MechDyn.den = [mot.J + mld.Jh/gbox.N^2,  mot.B + mld.Bh/gbox.N^2];
